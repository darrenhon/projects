...
public class RMIClient
{
  ...
  public static void main(String[] args)
  {
    ...
    {
      s_logger.LogWithScreen("NotBoundException:" + e.getMessage());
    }
    catch (Exception e)
    {
  ...
  public static void ParseAndRun(String command, ServerInterface server)
  {
    ...
    try
    {
      ...
      else if (results.length == 2 && results[0].equalsIgnoreCase("delete"))
      {
        ...
        s_logger.LogWithScreen("Delete " + (value == null ? "failed" : "successful"));
      }
